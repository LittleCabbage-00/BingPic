    ...
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                string fileName = $"bing_pic_{DateTime.Now:yyyy-MM-dd}-4k.jpg";
        ...
        private static async Task<(string? imageUrl, string? imageCopyright)> GetBingImageInfoAsync(string apiUrl)
        {
            ...
            string? urlBase = firstImage["urlbase"]?.ToString();
            string? imageCopyright = firstImage["copyright"]?.ToString();
            string? fullImageUrl = urlBase != null ? $"https://www.bing.com{urlBase}_UHD.jpg" : null;
